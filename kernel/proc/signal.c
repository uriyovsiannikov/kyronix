...
static void setup_sigframe(proc_t *p, int sig, syscall_frame_t *f) {
    ...
    mc->r8  = f->r8;   mc->r9  = f->r9;   mc->r10 = f->r10;
    mc->r11 = f->r11;  mc->r12 = f->r12;  mc->r13 = f->r13;
    mc->r14 = f->r14;  mc->r15 = f->r15;
    mc->rdi = f->rdi;  mc->rsi = f->rsi;  mc->rbp = f->rbp;
    mc->rbx = f->rbx;  mc->rdx = f->rdx;  mc->rax = f->rax;
    mc->rcx = f->rcx;
    mc->rsp = user_rsp;
    mc->rip = f->rcx;
    mc->eflags = f->r11;
